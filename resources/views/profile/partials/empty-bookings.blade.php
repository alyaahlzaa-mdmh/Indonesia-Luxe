<div class="py-16 flex flex-col items-center gap-4">
  ...
  <div class="text-center">
    <p class="text-gray-900 mb-1 font-medium">{{ __('bookings.nothing_here') }}</p>
    <p class="text-sm text-gray-500">{{ __('bookings.nothing_here_desc') }}</p>
  </div>
  <a class="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2.5 rounded-full text-sm transition font-semibold" href="{{ route('tours.index') }}" data-discover="true">{{ __('bookings.start_exploring') }}</a>
</div>