...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => $tourPackage->title]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tourPackage->title)]); ?>
...
[$__name, $__params] = $__split('guest.tour-detail', ['tourPackage' => $tourPackage]);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-351251805-0', $key);
...
<?php endif; ?>
<?php /**PATH /var/www/indonesia-luxe/resources/views/tours/show.blade.php ENDPATH**/ ?>