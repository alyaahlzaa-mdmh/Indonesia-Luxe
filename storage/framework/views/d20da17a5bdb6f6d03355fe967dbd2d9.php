...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => __('Dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div class="flex items-start justify-between mb-5">
                <div class="flex items-center gap-4">
                    <div class="relative">
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="absolute -bottom-1 -right-1 w-7 h-7 bg-white rounded-full shadow-md flex items-center justify-center border border-amber-200">
                    ...
                    <div>
                        ...
                        <p class="text-white text-xl"><?php echo e($user->name); ?></p>
                        <a class="flex items-center gap-1 text-white/80 text-sm mt-0.5" href="<?php echo e(route('profile.edit')); ?>" data-discover="true">
                            <?php echo e(__('profile.update_personal_info')); ?>
        ...
        <div class="px-4 pt-3 space-y-3">
            <div class="grid grid-cols-3 divide-x divide-gray-100 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="flex flex-col items-center py-4 px-2 opacity-50 transition group" href="/profile/promo-codes" data-discover="true">
                    ...
                    <span class="text-[10px] text-gray-500 text-center leading-tight">
                        <span class="block text-gray-400 text-[9px]"><?php echo e(__('profile.view')); ?></span><?php echo e(__('profile.promo_code')); ?>
                ...
                <div class="flex flex-col items-center py-4 px-2 opacity-50 transition group" href="/profile/luxe-points" data-discover="true">
                    ...
                    <span class="text-[10px] text-gray-500 text-center leading-tight">
                        <span class="block text-gray-400 text-[9px]"><?php echo e(__('profile.view')); ?></span>
                        <?php echo e(__('profile.luxe_points')); ?>
                ...
                <div class="flex flex-col items-center py-4 px-2 opacity-50 transition group" href="/profile/gift-cards" data-discover="true">
                    ...
                    <span class="text-[10px] text-gray-500 text-center leading-tight">
                        <span class="block text-gray-400 text-[9px]"><?php echo e(__('profile.view')); ?></span>
                        <?php echo e(__('profile.gift_cards')); ?>

                    </span>
                </div>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <a class="flex items-center gap-3 px-5 py-4 hover:bg-amber-50 transition " href="<?php echo e(route('bookings.index')); ?>" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.my_bookings')); ?></span>
                ...
                <a href="<?php echo e(route('profile.wishlist.index')); ?>" class="flex items-center gap-3 px-5 py-4 hover:bg-amber-50 transition border-t border-gray-50" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.wishlist')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </a>
                <div class="flex items-center gap-3 px-5 py-4 opacity-50 transition border-t border-gray-50" href="/profile/reviews" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.reviews')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </div>
                <div class="flex items-center gap-3 px-5 py-4 opacity-50 transition border-t border-gray-50" href="/profile/participants" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.participants')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </div>
                <div class="flex items-center gap-3 px-5 py-4 opacity-50 transition border-t border-gray-50" href="/profile/delivery" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.delivery')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="flex items-center gap-3 px-5 py-4 opacity-50 transition " href="/profile/settings" data-discover="true">
                    ...
                    <span class="flex-1 text-sm text-gray-700"><?php echo e(__('profile.settings')); ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </div>
                <button onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="w-full flex items-center gap-3 px-5 py-4 hover:bg-red-50 transition text-red-500 border-t border-gray-50 cursor-pointer">
                    ...
                    <span class="text-sm"><?php echo e(__('profile.logout')); ?></span>
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="flex gap-6 items-start">
                <aside class="w-72 shrink-0 self-start sticky top-20">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-4">
                        <div class="bg-linear-to-br from-amber-400 via-amber-500 to-amber-600 px-6 pt-6 pb-10 rounded-t-2xl">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-white text-lg"><?php echo e($user->name); ?></p>
                            </div>
                        </div>
                        <div class="-mt-6 px-6 pb-4">
                            <a class="flex items-center gap-2 bg-white shadow rounded-xl px-4 py-2.5 text-sm text-amber-600 hover:bg-amber-50 transition border border-amber-100" href="<?php echo e(route('profile.edit')); ?>" data-discover="true">
                        ...
                        <div class="border-t border-gray-100 rounded-b-2xl overflow-hidden opacity-50">
                            <div class="w-full flex items-center gap-3 px-6 py-3 transition text-sm text-gray-700 border-b border-gray-50 last:border-0" href="/profile/promo-codes" data-discover="true">
                                ...
                                <span class="flex-1 text-left text-gray-500 text-xs"><?php echo e(__('profile.view')); ?></span>
                                <span class="text-gray-900"><?php echo e(__('profile.promo_code')); ?></span>
                            ...
                            <div class="w-full flex items-center gap-3 px-6 py-3 transition text-sm text-gray-700 border-b border-gray-50 last:border-0" href="/profile/luxe-points" data-discover="true">
                                ...
                                <span class="flex-1 text-left text-gray-500 text-xs"><?php echo e(__('profile.view')); ?></span>
                                <span class="text-gray-900"><?php echo e(__('profile.luxe_points')); ?></span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-3.5 h-3.5 text-gray-300">
                                    <path d="m9 18 6-6-6-6"></path>
                                </svg>
                            </div>
                            <div class="w-full flex items-center gap-3 px-6 py-3 transition text-sm text-gray-700 border-b border-gray-50 last:border-0" href="/profile/gift-cards" data-discover="true">
                                ...
                                <span class="flex-1 text-left text-gray-500 text-xs"><?php echo e(__('profile.view')); ?></span>
                                <span class="text-gray-900"><?php echo e(__('profile.gift_cards')); ?></span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-3.5 h-3.5 text-gray-300">
                                    <path d="m9 18 6-6-6-6"></path>
                                </svg>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
                        <a class="flex items-center gap-3 px-5 py-3.5 hover:bg-amber-50 transition text-sm text-gray-700 " href="<?php echo e(route('bookings.index')); ?>" data-discover="true">
                            ...
                            <span class="flex-1"><?php echo e(__('profile.my_bookings')); ?></span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                                <path d="m9 18 6-6-6-6"></path>
                            </svg>
                        </a>
                        <a href="<?php echo e(route('profile.wishlist.index')); ?>" class="flex items-center gap-3 px-5 py-3.5 transition text-sm hover:bg-amber-50 text-gray-700 border-t border-gray-50" data-discover="true">
                            ...
                            <span class="flex-1"><?php echo e(__('profile.wishlist')); ?></span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4 text-gray-300">
                                <path d="m9 18 6-6-6-6"></path>
                            </svg>
                        </a>
                ...
                <div class="flex-1 min-w-0">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 overflow-hidden" x-data="{ tab: 'all' }">
                        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                            <div class="flex items-center gap-2">
                                <h2 class="text-gray-900 text-xl font-semibold"><?php echo e(__('profile.my_bookings')); ?></h2>
                            ...
                            <div class="hidden md:flex gap-2">
                                <button @click="tab = 'all'" :class="tab === 'all' ? 'bg-amber-500 text-white' : 'text-gray-500 hover:bg-gray-50'" class="capitalize px-4 py-1.5 rounded-full transition text-xs font-medium cursor-pointer"><?php echo e(__('profile.all')); ?></button>
                                <button @click="tab = 'upcoming'" :class="tab === 'upcoming' ? 'bg-amber-500 text-white' : 'text-gray-500 hover:bg-gray-50'" class="capitalize px-4 py-1.5 rounded-full transition text-xs font-medium cursor-pointer"><?php echo e(__('profile.upcoming')); ?></button>
                                <button @click="tab = 'completed'" :class="tab === 'completed' ? 'bg-amber-500 text-white' : 'text-gray-500 hover:bg-gray-50'" class="capitalize px-4 py-1.5 rounded-full transition text-xs font-medium cursor-pointer"><?php echo e(__('profile.completed')); ?></button>
                                <button @click="tab = 'cancelled'" :class="tab === 'cancelled' ? 'bg-amber-500 text-white' : 'text-gray-500 hover:bg-gray-50'" class="capitalize px-4 py-1.5 rounded-full transition text-xs font-medium cursor-pointer"><?php echo e(__('profile.cancelled')); ?></button>
                            </div>
                        </div>
                        ...
                        <div x-show="tab === 'all'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translateY-4" x-transition:enter-end="opacity-100 translateY-0">
                            ...
                            <?php echo $__env->make('profile.partials.booking-card', ['booking' => $booking], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php echo $__env->make('profile.partials.empty-bookings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div x-show="tab === 'completed'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translateY-4" x-transition:enter-end="opacity-100 translateY-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $completedBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php echo $__env->make('profile.partials.booking-card', ['booking' => $booking], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php echo $__env->make('profile.partials.empty-bookings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div x-show="tab === 'cancelled'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translateY-4" x-transition:enter-end="opacity-100 translateY-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cancelledBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php echo $__env->make('profile.partials.booking-card', ['booking' => $booking], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php echo $__env->make('profile.partials.empty-bookings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100">
                            <h2 class="text-gray-900 text-xl font-semibold"><?php echo e(__('profile.favorite_choices')); ?></h2>
                        </div>
                        <div class="py-16 flex flex-col items-center gap-4">
                            ...
                            <div class="text-center">
                                <p class="text-gray-900 mb-1"><?php echo e(__('profile.no_favorite')); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e(__('profile.favorite_desc')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /var/www/indonesia-luxe/resources/views/profile/index.blade.php ENDPATH**/ ?>