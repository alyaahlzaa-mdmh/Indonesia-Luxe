  ...
  <div class="px-5 py-5 border-b border-gray-100">
    ...
    <div class="flex items-center gap-3">
      <div class="w-9 h-9 rounded-xl bg-linear-to-br from-[#b8860b] to-amber-400 flex items-center justify-center text-white text-base font-medium shrink-0">
        ...
        <img src="<?php echo e(auth()->user()->getAvatarUrl()); ?>" class="w-full h-full object-cover rounded-xl border border-white/20">
        <?php else: ?>
      ...
      <div class="min-w-0">
        <p class="text-sm text-gray-800 font-medium truncate"><?php echo e(auth()->user()->name); ?></p>
        <p class="text-[10px] text-gray-400 truncate"><?php echo e(auth()->user()->email); ?></p>
      </div>
    </div>
  </div>
...
</aside><?php /**PATH C:\Users\fazar\indonesia-luxe-backup\indonesia-luxe\resources\views/vendor/partials/sidebar.blade.php ENDPATH**/ ?>