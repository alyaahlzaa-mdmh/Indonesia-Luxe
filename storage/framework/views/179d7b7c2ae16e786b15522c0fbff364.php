...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
  ...
  <div class="hidden lg:flex items-center justify-between mb-6">
    <div>
      ...
      <p class="text-xs text-gray-400 mt-0.5">Saldo Rp <?php echo e(number_format($wallet->balance, 0, ',', '.')); ?> · Earning &amp; penarikan dana</p>
    </div>
  </div>
  <div class="space-y-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
      <div class="bg-linear-to-br from-[#b8860b] to-amber-600 rounded-2xl p-5 text-white col-span-1 sm:col-span-1">
        ...
        <p class="text-2xl text-white">Rp&nbsp;<?php echo e(number_format($wallet->balance, 0, ',', '.')); ?></p>
      ...
      <div class="bg-white border border-gray-200 rounded-2xl p-5">
        ...
        <p class="text-emerald-700">Rp&nbsp;<?php echo e(number_format($wallet->total_earned, 0, ',', '.')); ?></p>
        <p class="text-[11px] text-gray-400 mt-1"><?php echo e($earningsCount); ?> transaksi</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-2xl p-5">
        ...
        <p class="text-purple-700">Rp&nbsp;<?php echo e(number_format($wallet->total_withdrawn, 0, ',', '.')); ?></p>
        <p class="text-[11px] text-gray-400 mt-1"><?php echo e($withdrawalsCount); ?> kali penarikan</p>
      </div>
    </div>
    <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
      <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        <div>
          ...
          <?php echo e($wallet->balance < 50000 ? 'disabled' : ''); ?> 
    ...
    <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
      <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        ...
        <div class="flex gap-1">
          <a href="<?php echo e(route('vendor.wallet.index', ['filter' => 'all'])); ?>" 
             class="text-xs px-2.5 py-1 rounded-lg transition <?php echo e($filter === 'all' ? 'bg-amber-100 text-amber-700' : 'text-gray-400 hover:text-gray-700'); ?>">
            Semua
          </a>
          <a href="<?php echo e(route('vendor.wallet.index', ['filter' => 'earning'])); ?>" 
             class="text-xs px-2.5 py-1 rounded-lg transition <?php echo e($filter === 'earning' ? 'bg-emerald-100 text-emerald-700' : 'text-gray-400 hover:text-gray-700'); ?>">
            Masuk
          </a>
          <a href="<?php echo e(route('vendor.wallet.index', ['filter' => 'withdrawal'])); ?>" 
             class="text-xs px-2.5 py-1 rounded-lg transition <?php echo e($filter === 'withdrawal' ? 'bg-red-100 text-red-700' : 'text-gray-400 hover:text-gray-700'); ?>">
            Keluar
          </a>
        </div>
      </div>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="px-5 py-4 flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center <?php echo e($transaction->type->value === 'earning' ? 'bg-emerald-50' : 'bg-red-50'); ?>">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->type->value === 'earning'): ?>
                ...
                <div>
                  <p class="text-sm text-gray-900">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->type->value === 'earning'): ?>
                      ...
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->booking?->tourPackage): ?>
                        - <?php echo e($transaction->booking->tourPackage->title); ?>
                  ...
                  <p class="text-xs text-gray-400"><?php echo e($transaction->created_at->format('d M Y, H:i')); ?></p>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->description): ?>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($transaction->description); ?></p>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
              </div>
              <div class="text-right">
                <p class="text-sm font-medium <?php echo e($transaction->type->value === 'earning' ? 'text-emerald-600' : 'text-red-600'); ?>">
                  <?php echo e($transaction->type->value === 'earning' ? '+' : '-'); ?>Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?>
      ...
      <?php else: ?>
        <div class="py-16 text-center">
          ...
          <p class="text-sm text-gray-400">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filter === 'earning'): ?>
  ...
  <div id="withdrawModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
      <form action="<?php echo e(route('vendor.wallet.withdraw')); ?>" method="POST" id="withdrawForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="p-6 space-y-4">
          ...
          <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
            ...
            <p class="text-2xl font-bold text-amber-900">Rp <?php echo e(number_format($wallet->balance, 0, ',', '.')); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
              ...
              <input 
                ...
                value="<?php echo e($user->vendorProfile->bank_account_name ?? $user->name); ?>"
                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
                placeholder="Nama sesuai rekening bank"
                required>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['bank_account_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
              ...
              <input 
                ...
                value="<?php echo e($user->vendorProfile->bank_account_number ?? ''); ?>"
                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
                placeholder="1234567890"
                required>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['bank_account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  ...
  <script>
    ...
    <?php if($user->vendorProfile && $user->vendorProfile->bank_name): ?>
      document.getElementById('bank_name').value = "<?php echo e($user->vendorProfile->bank_name); ?>";
    <?php endif; ?>
  </script>
...
<?php endif; ?><?php /**PATH C:\Users\fazar\indonesia-luxe-backup\indonesia-luxe\resources\views/vendor/wallet/index.blade.php ENDPATH**/ ?>