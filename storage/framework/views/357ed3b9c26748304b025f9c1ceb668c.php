...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => 'Checkout']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Checkout')]); ?>
...
[$__name, $__params] = $__split('checkout', ['cartItems' => $cart->items,'selectedIds' => $selectedIds ?? []]);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3390737570-0', $key);
...
<?php endif; ?><?php /**PATH /var/www/indonesia-luxe/resources/views/checkout/create.blade.php ENDPATH**/ ?>