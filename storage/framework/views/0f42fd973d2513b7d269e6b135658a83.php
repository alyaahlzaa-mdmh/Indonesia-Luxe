<div class="min-h-screen bg-gray-50"
  ...
  <div x-show="showToast"
    ...
    <div class="flex-1">
      <p class="text-sm font-semibold text-gray-900"><?php echo e(__('checkout.booking_success')); ?></p>
  ...
  <div class="max-w-2xl mx-auto lg:px-4 py-8">
    ...
    <div class="flex items-center justify-center mb-8 gap-0">
      <div class="flex items-center">
        <div class="flex flex-col items-center gap-1">
          <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm transition-all <?php echo e($step == 1 ? 'bg-amber-500 text-white shadow-md' : 'bg-green-500 text-white'); ?>">
          ...
          <span class="text-xs <?php echo e($step == 1 ? 'text-amber-600' : 'text-gray-400'); ?> hidden sm:block"><?php echo e(__('checkout.step_1')); ?></span>
        </div>
        <div class="w-12 md:w-20 h-0.5 mx-1 mb-4 transition-colors <?php echo e($step > 1 ? 'bg-green-500' : 'bg-gray-200'); ?>"></div>
      </div>
      <div class="flex items-center">
        <div class="flex flex-col items-center gap-1">
          <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm transition-all <?php echo e($step == 2 ? 'bg-amber-500 text-white shadow-md' : ($step > 2 ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-500')); ?>">
          ...
          <span class="text-xs <?php echo e($step == 2 ? 'text-amber-600' : 'text-gray-400'); ?> hidden sm:block"><?php echo e(__('checkout.step_2')); ?></span>
        </div>
        <div class="w-12 md:w-20 h-0.5 mx-1 mb-4 transition-colors <?php echo e($step > 2 ? 'bg-green-500' : 'bg-gray-200'); ?>"></div>
      </div>
      <div class="flex items-center">
        <div class="flex flex-col items-center gap-1">
          <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm transition-all <?php echo e($step == 3 ? 'bg-amber-500 text-white shadow-md' : 'bg-gray-200 text-gray-500'); ?>">3</div>
          <span class="text-xs <?php echo e($step == 3 ? 'text-amber-600' : 'text-gray-400'); ?> hidden sm:block"><?php echo e(__('checkout.step_3')); ?></span>
        </div>
      </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 1): ?>
    <!-- STEP 1 -->
    <div class="space-y-4" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('step-1', get_defined_vars()); ?>wire:key="step-1">
      <a href="<?php echo e(route('cart.index')); ?>" class="flex items-center gap-1.5 text-gray-500 hover:text-gray-700 text-sm transition mb-2">
        ...
        <?php echo e(__('checkout.back_to_cart')); ?>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900"><?php echo e(__('checkout.step_1')); ?></h3>
        </div>
        <div class="space-y-4">
          <div>
            <label class="text-sm text-gray-600 block mb-1.5"><?php echo e(__('checkout.full_name')); ?> <span class="text-red-400">*</span></label>
            <input type="text" wire:model="name" value="<?php echo e($name); ?>" placeholder="<?php echo e(__('checkout.name_placeholder')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition bg-white">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div>
            <label class="text-sm text-gray-600 block mb-1.5"><?php echo e(__('checkout.email')); ?> <span class="text-red-400">*</span></label>
            <input type="email" wire:model="email" value="<?php echo e($email); ?>" placeholder="<?php echo e(__('checkout.email_placeholder')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition bg-white">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div>
            <label class="text-sm text-gray-600 block mb-1.5"><?php echo e(__('checkout.phone')); ?> <span class="text-red-400">*</span></label>
            <div class="flex gap-2">
              ...
              <input type="tel" wire:model="phone" value="<?php echo e($phone); ?>" placeholder="<?php echo e(__('checkout.phone_placeholder')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition bg-white">
            </div>
            <p class="text-xs text-gray-400 mt-1"><?php echo e(__('checkout.phone_note')); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div>
            <label class="text-sm text-gray-600 block mb-1.5"><?php echo e(__('checkout.note')); ?></label>
            <textarea wire:model="note" placeholder="<?php echo e(__('checkout.note_placeholder')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition bg-white resize-none" rows="3"></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdminPackage || $hasPickupPoints): ?>
      <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-blue-100 mb-4" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('pickup-{{ $item->id }}', get_defined_vars()); ?>wire:key="pickup-<?php echo e($item->id); ?>">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div class="min-w-0 pt-0.5">
            <h3 class="text-gray-900 font-bold text-[13px] sm:text-sm leading-tight">
              <?php echo e(__('checkout.pickup_point_prefix')); ?>

              <span class="font-normal text-gray-500 block mt-0.5 sm:inline sm:mt-0"><?php echo e(Str::limit($item->tourPackage->title, 50)); ?></span>
            </h3>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="relative group">
              ...
              <input type="text" wire:model.live="pickupPoints.<?php echo e($item->id); ?>" placeholder="<?php echo e(__('checkout.pickup_placeholder')); ?>" class="w-full border border-blue-100 rounded-xl pl-10 pr-4 py-3 text-sm outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition bg-gray-50/50 focus:bg-white placeholder:text-gray-400">
            </div>
          </div>
          <?php else: ?>
          <div class="space-y-2">
            <div class="relative group">
              ...
              <select wire:model.live="pickupPoints.<?php echo e($item->id); ?>" class="w-full border border-blue-100 rounded-xl pl-10 pr-10 py-3 text-sm outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition bg-gray-50/50 focus:bg-white appearance-none cursor-pointer text-gray-800">
                <option value=""><?php echo e(__('checkout.select_pickup')); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item->tourPackage->pickupPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pickupPoints[$item->id]) && $pickupPoints[$item->id]): ?>
          <div class="flex items-center gap-1.5 pl-1.5 py-1">
            ...
            <p class="text-[11px] text-blue-600 leading-tight">
              <?php echo e(__('checkout.selected_pickup_confirm')); ?> <span class="font-bold"><?php echo e($pickupPoints[$item->id]); ?></span>
            </p>
          </div>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($anyPickup): ?>
      <div class="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-start gap-3 mb-8">
        ...
        <p class="text-[11px] sm:text-xs text-blue-600 leading-relaxed">
          <span class="font-bold uppercase tracking-wider text-[10px]"><?php echo e(__('checkout.pickup_service_title')); ?></span> — <?php echo e(__('checkout.pickup_service_desc')); ?>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900"><?php echo e(__('checkout.transfer_info')); ?></h3>
        </div>
        <p class="text-xs text-gray-500 mb-4"><?php echo e(__('checkout.transfer_desc')); ?></p>
        <div class="space-y-3">
          <div class="border rounded-xl p-4 bg-yellow-50 border-yellow-200">
            ...
            <div class="flex items-center justify-between gap-3">
              <div class="min-w-0">
                ...
                <p class="text-xs text-gray-500 mt-0.5"><?php echo e(__('checkout.acc_holder')); ?> <span class="text-gray-700">Alina Saidja Putri</span></p>
              </div>
              <button type="button"
        ...
        <div class="mt-3 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3 flex items-start gap-2">
          ...
          <p class="text-xs text-amber-700 leading-relaxed"><?php echo e(__('checkout.transfer_warning')); ?></p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900"><?php echo e(__('checkout.payment')); ?></h3>
        </div>

        <div class="flex flex-col gap-4">
          <!-- PAYMENT PROOF INPUT -->
          <div>
            <label class="text-sm text-gray-600 block mb-1.5"><?php echo e(__('checkout.payment_proof')); ?> <span class="text-red-400">*</span></label>
            <div
              ...
              <template x-if="!previewSrc && fileName">
                <div>
                  ...
                  <p class="text-xs text-green-600">✓ <?php echo e(__('checkout.file_selected')); ?></p>
                </div>
              </template>
              ...
              <template x-if="!fileName">
                <div>
                  ...
                  <div wire:loading wire:target="proof" class="flex flex-col items-center mb-2">
                    ...
                    <p class="text-xs text-amber-500"><?php echo e(__('checkout.upload_server')); ?></p>
                  </div>
                  <div wire:loading.remove wire:target="proof">
                    ...
                    <p class="text-sm text-gray-500"><?php echo e(__('checkout.upload_placeholder')); ?></p>
                    <p class="text-xs text-gray-400 mt-2"><?php echo e(__('checkout.upload_formats')); ?></p>
                  </div>
                </div>
              </template>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 text-center block mt-2"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <p x-show="previewSrc == null" class="text-xs text-gray-400 text-center mt-2"><?php echo e(__('checkout.proof_required')); ?></p>
            <div x-show="previewSrc != null" class="flex items-center justify-end mt-2">
              <button @click="removeFile()" class="text-xs text-red-400 hover:text-red-600 transition flex items-center gap-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x w-3.5 h-3.5">
                  <path d="M18 6 6 18"></path>
                  <path d="m6 6 12 12"></path>
                </svg> <?php echo e(__('checkout.delete')); ?>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900"><?php echo e(__('checkout.order_summary')); ?> (<?php echo e($selectedItems->count()); ?> <?php echo e(__('checkout.packages')); ?>)</h3>
        </div>
        <div class="space-y-3">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          <div class="flex gap-3 p-3 bg-gray-50 rounded-xl">
            <img src="<?php echo e(Storage::url($item->tourPackage->cover_image_path)); ?>" alt="<?php echo e($item->tourPackage->title); ?>" class="w-16 h-16 object-cover rounded-lg shrink-0">
            <div class="flex-1 min-w-0">
              <p class="text-sm text-gray-900 line-clamp-2 leading-snug mb-1"><?php echo e($item->tourPackage->title); ?></p>
              <p class="text-xs text-gray-500">📅 <?php echo e($item->slot->departure_date->format('Y-m-d')); ?> · 👥 <?php echo e($item->quantity); ?> <?php echo e(__('tour_card.person')); ?></p>
              <span class="text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full mt-1 inline-block">
                <?php echo e($item->tourPackage->category->name ?? 'Uncategorized'); ?>

              </span>
            </div>
            <div class="text-right shrink-0">
              <p class="text-sm text-amber-600">Rp <?php echo e(number_format($item->line_total, 0, ',', '.')); ?></p>
              <p class="text-xs text-gray-400">Rp <?php echo e(number_format($item->price_per_person, 0, ',', '.')); ?>/org</p>
            </div>
          </div>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div class="space-y-2 mb-3">
          <div class="flex justify-between text-sm text-gray-600">
            <span><?php echo e(__('checkout.subtotal')); ?> (<?php echo e($selectedItems->count()); ?> <?php echo e(__('checkout.packages')); ?>)</span>
            <span>Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
          </div>
        </div>
        <div class="border-t border-gray-100 pt-3 flex justify-between items-center">
          <span class="text-gray-900 font-medium"><?php echo e(__('checkout.total_payment')); ?></span>
          <div class="text-right"><span class="text-amber-600 text-lg font-bold">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span></div>
        </div>
      </div>
      ...
      <button type="button" wire:click="nextStep" wire:loading.attr="disabled" wire:target="nextStep" class="w-full bg-amber-500 hover:bg-amber-600 active:bg-amber-700 disabled:opacity-60 text-white py-4 rounded-2xl transition flex items-center justify-center gap-2 shadow-md cursor-pointer font-semibold">
        <span wire:loading.remove wire:target="nextStep" class="flex items-center gap-2">
          <?php echo e(__('checkout.next_step')); ?>
        ...
        <span wire:loading wire:target="nextStep"><?php echo e(__('checkout.validating')); ?></span>
      </button>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 2): ?>
    <!-- STEP 2 -->
    <div class="space-y-4" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('step-2', get_defined_vars()); ?>wire:key="step-2">
      <button wire:click="previousStep" class="flex items-center gap-1.5 text-gray-500 hover:text-gray-700 text-sm transition mb-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left w-4 h-4">
          <path d="m12 19-7-7 7-7"></path>
          <path d="M19 12H5"></path>
        </svg>
        <?php echo e(__('checkout.change_data')); ?>
      ...
      <div class="bg-green-50 border border-green-200 rounded-2xl px-5 py-4 flex items-start gap-3">
        ...
        <div>
          <p class="text-sm text-green-800 font-medium"><?php echo e(__('checkout.wa_confirm_title')); ?></p>
          <p class="text-xs text-green-600 mt-0.5"><?php echo e(__('checkout.wa_confirm_desc')); ?></p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="space-y-1.5 text-sm">
          <div class="flex items-start gap-3 py-1.5 border-b border-gray-50 last:border-0">
            ...
            <span class="text-gray-400 w-20 shrink-0 text-xs mt-0.5"><?php echo e(__('checkout.name')); ?></span>
            <span class="text-gray-900 flex-1 leading-snug font-medium"><?php echo e($name); ?></span>
          </div>
          <div class="flex items-start gap-3 py-1.5 border-b border-gray-50 last:border-0">
            ...
            <span class="text-gray-900 flex-1 leading-snug font-medium"><?php echo e($email); ?></span>
          </div>
          <div class="flex items-start gap-3 py-1.5 border-b border-gray-50 last:border-0">
            ...
            <span class="text-gray-900 flex-1 leading-snug font-medium">+62 <?php echo e($phone); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="space-y-2">
          ...
          <img src="<?php echo e($proof->temporaryUrl()); ?>" alt="<?php echo e(__('checkout.payment_proof')); ?>" class="w-full max-h-64 object-contain rounded-xl border border-gray-100 bg-gray-50">
          <p class="text-xs text-green-600 flex items-center gap-1.5">
            ...
            <?php echo e(__('checkout.proof_ready')); ?>
          ...
          <div class="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-xl p-4">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-sm text-amber-800"><?php echo e(__('checkout.proof_not_uploaded')); ?></p>
              <p class="text-xs text-amber-600 mt-0.5"><?php echo e(__('checkout.proof_not_uploaded_desc')); ?></p>
            </div>
            <div class="flex flex-col items-center">
              <button
                ...
                <?php echo e(__('checkout.upload_btn')); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900"><?php echo e(__('checkout.order_details')); ?> (<?php echo e($selectedItems->count()); ?> <?php echo e(__('checkout.packages')); ?>)</h3>
        </div>
        <div class="space-y-3">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          <div class="border border-gray-100 rounded-xl overflow-hidden">
            <div class="flex gap-3 p-3 bg-gray-50">
              <img src="<?php echo e(Storage::url($item->tourPackage->cover_image_path)); ?>" alt="<?php echo e($item->tourPackage->title); ?>" class="w-14 h-14 object-cover rounded-lg shrink-0">
              <div class="flex-1 min-w-0">
                <p class="text-sm text-gray-900 leading-snug font-medium"><?php echo e($item->tourPackage->title); ?></p>
                <span class="text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full mt-1 inline-block">
                  <?php echo e($item->tourPackage->category->name ?? 'Uncategorized'); ?>
            ...
            <div class="px-3 py-2.5 grid grid-cols-2 gap-y-1 text-xs">
              <span class="text-gray-400">📅 <?php echo e(__('checkout.date')); ?></span>
              <span class="text-gray-800 text-right font-medium"><?php echo e($item->slot->departure_date->format('Y-m-d')); ?></span>
              <span class="text-gray-400">👥 <?php echo e(__('checkout.participants')); ?></span>
              <span class="text-gray-800 text-right font-medium"><?php echo e($item->quantity); ?> <?php echo e(__('tour_card.person')); ?></span>
              <span class="text-gray-400">💵 <?php echo e(__('checkout.price_per_person')); ?></span>
              <span class="text-gray-800 text-right">Rp <?php echo e(number_format($item->price_per_person, 0, ',', '.')); ?></span>
              <span class="text-gray-400 font-medium">💰 <?php echo e(__('checkout.subtotal')); ?></span>
              <span class="text-amber-600 text-right font-bold">Rp <?php echo e(number_format($item->line_total, 0, ',', '.')); ?></span>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->pickup_point): ?>
              <span class="text-gray-400 col-span-2 mt-1 pt-1 border-t border-gray-100 flex items-center gap-1">
                📍 <span class="font-medium text-gray-700"><?php echo e(__('checkout.selected_pickup_confirm')); ?> <?php echo e($item->pickup_point); ?></span>
              </span>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
          </div>
      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-gray-900 font-medium"><?php echo e(__('checkout.transaction_details')); ?></h3>
        </div>
        <div class="space-y-2.5">
          <div class="flex justify-between text-sm text-gray-600">
            <span><?php echo e(__('checkout.initial_subtotal')); ?> (<?php echo e($selectedItems->count()); ?> <?php echo e(__('checkout.packages')); ?>)</span>
            <span>Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
          </div>
          <div class="border-t border-gray-100 pt-3 flex justify-between items-center">
            <span class="text-gray-900 font-medium"><?php echo e(__('checkout.total_payment')); ?></span>
            <div class="text-right">
              <span class="text-amber-600 text-xl font-bold">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <button wire:click="submitBooking" wire:loading.attr="disabled" class="w-full bg-green-500 hover:bg-green-600 active:bg-green-700 disabled:bg-green-300 text-white py-4 rounded-2xl transition flex items-center justify-center gap-3 shadow-md cursor-pointer font-bold">
        <span wire:loading.remove wire:target="submitBooking" class="flex items-center gap-3">
          ...
          <?php echo e(__('checkout.confirm_wa')); ?>

        </span>
        <span wire:loading wire:target="submitBooking"><?php echo e(__('checkout.processing')); ?></span>
      </button>
      <p class="text-xs text-center text-gray-400 px-4"><?php echo e(__('checkout.wa_template_note')); ?></p>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 3): ?>
    <!-- STEP 3 -->
    <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center animate-in fade-in slide-in-from-bottom-4 duration-500" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('step-3', get_defined_vars()); ?>wire:key="step-3">
      ...
      <h2 class="text-gray-900 mb-1 text-2xl font-bold"><?php echo e(__('checkout.order_sent')); ?></h2>
      <p class="text-sm text-gray-500 mb-1"><?php echo e(__('checkout.order_number')); ?>: <span class="text-gray-900 font-mono select-all font-semibold"><?php echo e($order?->code ?? '-'); ?></span></p>
      <p class="text-xs text-gray-400 mb-6"><?php echo e(__('checkout.wa_cs_opened')); ?></p>
      ...
      <div class="mb-5 text-left bg-green-50 border border-green-100 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p class="text-sm text-green-800 font-medium"><?php echo e(__('checkout.order_recorded')); ?></p>
          <p class="text-xs text-green-600 mt-0.5"><?php echo e(__('checkout.order_recorded_desc')); ?></p>
        </div>
      </div>

      <div class="bg-amber-50 border border-amber-100 rounded-2xl p-4 mb-6 text-left space-y-2">
        <p class="text-xs text-amber-700 mb-1 font-medium"><?php echo e(__('checkout.payment_summary')); ?></p>
        <div class="flex justify-between text-sm text-gray-600">
          <span><?php echo e(__('checkout.total_payment')); ?></span>
          <span class="font-semibold text-gray-900">Rp <?php echo e(number_format((float) ($order?->total_amount ?? 0), 0, ',', '.')); ?></span>
        </div>
      </div>

      <div class="flex flex-col sm:flex-row gap-3">
        <a href="<?php echo e(getWhatsappMeUrl()); ?>" target="_blank" rel="noopener noreferrer" class="flex-1 inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-3 rounded-xl transition font-semibold">
          ...
          <?php echo e(__('checkout.open_wa')); ?>

        </a>
        <a href="<?php echo e(route('bookings.index')); ?>" class="flex-1 inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-5 py-3 rounded-xl transition font-semibold"><?php echo e(__('checkout.view_booking')); ?></a>
      </div>
      <a href="<?php echo e(route('home')); ?>" class="mt-3 text-sm text-gray-400 hover:text-gray-600 transition block mx-auto underline underline-offset-4"><?php echo e(__('checkout.back_to_home')); ?></a>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  </div>
  ...
  <div x-show="showCopyToast"
    ...
    <?php echo e(__('checkout.account_copied')); ?>

  </div>
</div><?php /**PATH /var/www/indonesia-luxe/resources/views/livewire/checkout.blade.php ENDPATH**/ ?>