...
<div class="max-w-6xl mx-auto px-4 w-full">
    ...
    <section class="mb-20 text-center">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:flex md:flex-wrap md:justify-center gap-4 md:gap-5 pb-6">
            ...
            <a href="<?php echo e(route('tours.index')); ?>?type=<?php echo e($typeValue); ?>" class="flex flex-col items-center group w-full md:w-[136px]">
...
</script><?php /**PATH /var/www/indonesia-luxe/resources/views/livewire/guest/home-page.blade.php ENDPATH**/ ?>