...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => __('Wishlist'),'fullWidth' => true,'session' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Wishlist')),'fullWidth' => true,'session' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
  ...
  <div class="sticky top-16 z-30 bg-white border-b border-gray-100">
    <div class="max-w-2xl mx-auto px-4">
      <div class="flex items-center h-14 gap-3">
        ...
        <span class="text-sm text-gray-400"><?php echo e($wishlist->count()); ?> paket</span>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-2xl mx-auto px-4 py-5" wire:loading.class="opacity-50">
    <div class="flex flex-col gap-3">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $wishlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('wishlist-item-{{ $tour->id }}', get_defined_vars()); ?>wire:key="wishlist-item-<?php echo e($tour->id); ?>">
        <a class="w-28 h-28 shrink-0 block" href="<?php echo e(route('tours.show', $tour)); ?>">
          <img src="<?php echo e($tour->coverImageUrl()); ?>" alt="<?php echo e($tour->title); ?>" class="w-full h-full object-cover">
        </a>
        <div class="flex-1 p-3 min-w-0">
          <div class="flex items-start justify-between gap-2">
            <a class="flex-1 min-w-0" href="<?php echo e(route('tours.show', $tour)); ?>">
              <span class="text-[10px] bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full"><?php echo e($tour->category->name); ?></span>
              <p class="text-sm text-gray-900 mt-1 line-clamp-2 leading-snug"><?php echo e($tour->title); ?></p>
            </a>
            <form action="<?php echo e(route('profile.wishlist.destroy', $tour->id)); ?>" method="POST">
              <?php echo csrf_field(); ?>
          ...
          <div class="flex items-center gap-1 mt-1 text-amber-400">
            ...
            <span class="text-xs text-gray-600"><?php echo e(number_format($tour->reviews_avg_rating ?? 0, 1)); ?> (<?php echo e($tour->reviews_count); ?>)</span>
          </div>
          <div class="flex items-center gap-1 mt-0.5 text-gray-400">
            ...
            <span class="text-xs truncate"><?php echo e($tour->meeting_point); ?></span>
          </div>
          <p class="text-amber-600 font-bold text-sm mt-1">Rp <?php echo e(number_format($tour->price_per_person, 0, ',', '.')); ?></p>
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center py-20 gap-5">
        ...
        <a href="<?php echo e(route('tours.index')); ?>" data-discover="true" class="flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-2.5 rounded-full text-sm transition">
...
<?php endif; ?><?php /**PATH /var/www/indonesia-luxe/resources/views/wishlists/index.blade.php ENDPATH**/ ?>