            ...
            <div class="w-full md:w-1/2 p-10 overflow-y-auto">
                ...
                <div class="grid grid-cols-2 gap-4 mb-10">
                    <div class="bg-[#fffcf0] p-6 rounded-2xl border border-[#fff5cc]">
                        ...
                        <p class="text-2xl font-bold text-[#1e1e1e]">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPackage->price_per_person >= 1000000): ?>
                                Rp <?php echo e(number_format($selectedPackage->price_per_person / 1000000, 1)); ?>jt
                            <?php else: ?>
                                Rp <?php echo e(number_format($selectedPackage->price_per_person / 1000, 0)); ?>rb
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                        ...
                        <p class="text-2xl font-bold text-[#1e1e1e]">
                            <?php echo e($selectedPackage->duration_hours ? ceil($selectedPackage->duration_hours / 24) : '1'); ?> Hari
                        </p>
                    </div>
                </div>
...
<?php /**PATH /var/www/indonesia-luxe/resources/views/livewire/admin/package-management.blade.php ENDPATH**/ ?>