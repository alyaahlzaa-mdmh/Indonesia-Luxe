...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => 'Indonesia Luxe','fullWidth' => true,'clean' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Indonesia Luxe'),'fullWidth' => true,'clean' => true]); ?>
    ...
    <div class="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-lg">
            <div class="text-center mb-6">
                <img src="<?php echo e(asset('/images/logo.png')); ?>" alt="Indonesia Luxe" class="h-14 mx-auto mb-2 drop-shadow-xl">
            </div>
            <div class="bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                ...
                <div class="px-8 py-7 space-y-7">
                    <div class="text-center">
                        <p class="text-white/90 text-sm">Halo, <span class="text-amber-300"><?php echo e(auth()->user()->name); ?></span>! 👋</p>
                        <p class="text-white/60 text-xs mt-1"><?php echo e(auth()->user()->email); ?></p>
                    </div>
                    ...
                    <div class="bg-white/8 rounded-2xl border border-white/15 p-4 space-y-2">
                        ...
                        <div class="flex items-center gap-3 pt-1">
                            ...
                            <p class="text-white/60 text-xs">Notifikasi dikirim ke: <span class="text-white/90"><?php echo e(auth()->user()->email); ?></span>
                            </p>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <p class="text-center text-white/60 text-xs">Ingin proses lebih cepat? Hubungi CS kami langsung</p>
                        <a href="<?php echo e($waUrl); ?>" target="_blank" class="w-full flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 active:scale-95 text-white py-3.5 rounded-2xl transition-all shadow-lg shadow-green-500/30 group">
                            ...
                            <span class="text-sm">Chat CS</span>
...
<?php endif; ?>
<?php /**PATH C:\Users\fazar\indonesia-luxe-backup\indonesia-luxe\resources\views/vendor/pending.blade.php ENDPATH**/ ?>