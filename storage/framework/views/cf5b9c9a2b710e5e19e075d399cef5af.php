<header class="bg-white border-b h-16 flex items-center justify-between px-4 md:px-6 shrink-0 z-10 sticky top-0">
    <div class="flex items-center gap-3 md:gap-4">
        ...
        <!-- Logo here -->
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 md:gap-3">
            <img src="<?php echo e(asset('apple-touch-icon.png')); ?>" alt="Indonesia Luxe Logo" class="h-7 md:h-8 w-auto rounded" />
    ...
    <div class="flex items-center gap-3 md:gap-6">
        ...
        <div class="relative" x-data="{ open: false, confirmingLogout: false }" @click.away="open = false" @close.stop="open = false; confirmingLogout = false">
            ...
            <form id="admin-logout-form" method="POST" action="<?php echo e(route('logout')); ?>" class="hidden">
                <?php echo csrf_field(); ?>
            </form>
...
<?php /**PATH C:\Users\fazar\indonesia-luxe-backup\indonesia-luxe\resources\views/components/admin/topbar.blade.php ENDPATH**/ ?>