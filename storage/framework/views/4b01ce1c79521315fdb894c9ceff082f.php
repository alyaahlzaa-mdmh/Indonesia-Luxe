...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.vendor','data' => ['title' => 'Vendor Promo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Vendor Promo')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div x-data="{
        ...
        promoCode: '',
        giftCode: '',
        generatePromo() { this.promoCode = (<?php echo e($generatePromoCode); ?>)(); },
        generateGift() { this.giftCode = (<?php echo e($generateGiftCode); ?>)(); }
    }">
        <div class="space-y-6">
            <div class="flex gap-1 bg-gray-100 rounded-xl p-1">
                <button @click="tab = 'promo'"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promos->count() > 0): ?>
                        <span
                            class="min-w-4.5 h-4.5 px-1 rounded-full bg-amber-100 text-amber-700 text-[10px] flex items-center justify-center"><?php echo e($promos->count()); ?></span>
                ...
                <button @click="tab = 'gift'"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($giftCards->count() > 0): ?>
                        <span
                            class="min-w-4.5 h-4.5 px-1 rounded-full bg-amber-100 text-amber-700 text-[10px] flex items-center justify-center"><?php echo e($giftCards->count()); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </button>
            </div>
            ...
            <div x-show="tab == 'promo'" class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promos->count() > 0): ?>
                    <div class="grid grid-cols-3 gap-2">
                        <div
                            ...
                            <div>
                                <p class="text-lg leading-none text-amber-700"><?php echo e($pendingPromos); ?></p>
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-lg leading-none text-emerald-700"><?php echo e($activePromos); ?></p>
                        ...
                        <div class="flex items-center gap-2.5 bg-red-50 border border-red-100 rounded-xl px-3 py-2.5">
                            ...
                            <div>
                                <p class="text-lg leading-none text-red-600"><?php echo e($rejectedPromos); ?></p>
                ...
                <div x-show="showCreatePromo" x-transition
                    ...
                    <form action="<?php echo e(route('vendor.promo.store')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $promos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div x-show="editingPromoId !== <?php echo e($promo->id); ?>"
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        <h4 class="text-sm font-bold text-gray-900 font-mono tracking-tight">
                                            <?php echo e($promo->code); ?></h4>
                                        <button
                                            @click="navigator.clipboard.writeText('<?php echo e($promo->code); ?>'); showCopyToast = true; setTimeout(() => showCopyToast = false, 3000)"
                                        ...
                                        <span
                                            class="inline-flex items-center gap-1 text-[10px] <?php echo e($promo->status->badgeClass()); ?> px-2 py-0.5 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <?php echo e($promo->status->label()); ?>

                                        </span>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-0.5 mb-2"><?php echo e($promo->description); ?></p>
                                    <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1.5">
                                        <span
                                            class="text-[10px] text-emerald-600 font-semibold bg-emerald-50 px-2 py-0.5 rounded text-nowrap">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promo->discount_type->value == 'percent'): ?>
                                                Diskon <?php echo e(number_format($promo->discount_value, 0)); ?>%
                                            <?php else: ?>
                                        ...
                                        <span class="text-[10px] text-gray-400">Min. Rp
                                            <?php echo e(number_format($promo->min_purchase, 0, ',', '.')); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promo->valid_until): ?>
                                            <span class="text-[10px] text-gray-400 flex items-center gap-1">
                                                ...
                                                Hingga <?php echo e($promo->valid_until->format('d M Y')); ?>
                            ...
                            <div class="hidden sm:block">
                                <div class="flex gap-1 shrink-0">
                                    <button @click="editingPromoId = <?php echo e($promo->id); ?>"
                                    ...
                                    <form action="<?php echo e(route('vendor.promo.destroy', $promo)); ?>" method="POST"
                        ...
                        <div x-show="editingPromoId === <?php echo e($promo->id); ?>" x-transition
                            ...
                            <form action="<?php echo e(route('vendor.promo.update', $promo)); ?>" method="POST"
                                class="space-y-4">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Kode Promo
                                            *</label>
                                        <input name="code" value="<?php echo e($promo->code); ?>" required
                                            placeholder="cth. LUXESUMMER25"
                                    ...
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Grup
                                            Promo</label>
                                        <input name="group" value="<?php echo e($promo->group); ?>"
                                ...
                                <div>
                                    <label class="text-xs text-gray-500 mb-1.5 block font-medium">Deskripsi Promo
                                        *</label>
                                    <input name="description" value="<?php echo e($promo->description); ?>" required
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <select name="discount_type"
                                            ...
                                            <option value="percent"
                                                <?php echo e($promo->discount_type->value == 'percent' ? 'selected' : ''); ?>>
                                                Persen (%)</option>
                                            <option value="flat"
                                                <?php echo e($promo->discount_type->value == 'flat' ? 'selected' : ''); ?>>Nominal
                                                (Rp)</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Nilai
                                            Diskon</label>
                                        <input name="discount_value" value="<?php echo e((float) $promo->discount_value); ?>"
                                    ...
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Min. Pembelian
                                            (Rp)</label>
                                        <input name="min_purchase" value="<?php echo e((float) $promo->min_purchase); ?>"
                                        ...
                                        <select name="category_restriction"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <option value="<?php echo e($category->name); ?>"
                                                    <?php echo e($promo->category_restriction == $category->name ? 'selected' : ''); ?>>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                                            <label class="text-xs text-gray-500 mb-1.5 block font-medium">Berlaku
                                                Dari</label>
                                            <input name="valid_from" type="date"
                                                value="<?php echo e($promo->valid_from?->format('Y-m-d')); ?>"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-amber-400 focus:ring-1 focus:ring-amber-200 outline-none transition bg-white">
                                        </div>
                                        <div>
                                            <label class="text-xs text-gray-500 mb-1.5 block font-medium">Berlaku
                                                Sampai</label>
                                            <input name="valid_until" type="date"
                                                value="<?php echo e($promo->valid_until?->format('Y-m-d')); ?>"
                                                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-amber-400 focus:ring-1 focus:ring-amber-200 outline-none transition bg-white">
                                        </div>
                                    </div>
                                </div>
            ...
            <div x-show="tab == 'gift'" class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($giftCards->count() > 0): ?>
                    <div class="grid grid-cols-3 gap-2">
                        <div class="flex items-center gap-2.5 bg-amber-50 border border-amber-100 rounded-xl px-3 py-2.5">
                            ...
                            <div>
                                <p class="text-lg leading-none text-amber-700"><?php echo e($pendingGiftCards); ?></p>
                                <p class="text-[10px] text-amber-500 mt-0.5">Menunggu</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div>
                                <p class="text-lg leading-none text-emerald-700"><?php echo e($activeGiftCards); ?></p>
                                <p class="text-[10px] text-emerald-500 mt-0.5">Disetujui</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2.5 bg-red-50 border border-red-100 rounded-xl px-3 py-2.5">
                            ...
                            <div>
                                <p class="text-lg leading-none text-red-600"><?php echo e($rejectedGiftCards); ?></p>
                                <p class="text-[10px] text-red-400 mt-0.5">Ditolak</p>
                            </div>
                        </div>
                    </div>
                ...
                <div x-show="showCreateGift" x-transition
                    class="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 shadow-sm">
                    <form action="<?php echo e(route('vendor.gift-card.store')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                ...
                <div class="space-y-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $giftCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $giftCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div x-show="editingGiftId !== <?php echo e($giftCard->id); ?>" class="bg-white border rounded-xl p-4 transition border-gray-200">
                            <div class="flex items-start justify-between mb-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-mono text-sm text-gray-900 tracking-wider"><?php echo e($giftCard->code); ?></span>
                                ...
                                <div class="hidden sm:block">
                                    <div class="flex gap-1 shrink-0">
                                        <button @click="editingGiftId = <?php echo e($giftCard->id); ?>"
                                            class="p-1.5 hover:bg-gray-100 rounded-lg transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <form action="<?php echo e(route('vendor.gift-card.destroy', $giftCard)); ?>" method="POST"
                            ...
                            <span class="inline-flex items-center gap-1 text-[10px] <?php echo e($promo->status->badgeClass()); ?> px-2 py-0.5 rounded-full">
                            ...
                            <div class="space-y-1.5 text-xs mt-2">
                                <div class="flex justify-between text-gray-500">
                                    ...
                                    <span class="text-gray-900">Rp <?php echo e(number_format($giftCard->value, 0, ',', '.')); ?></span>
                                    </div>
                                <div class="flex justify-between text-gray-500">
                                    <span>Kuota Pengguna</span>
                                    <span class="text-emerald-600"><?php echo e($giftCard->used_count); ?>/<?php echo e($giftCard->max_usages); ?> (sisa <?php echo e($giftCard->max_usages - $giftCard->used_count); ?>x)</span>
                                    </div>
                                ...
                                <div class="flex justify-between text-gray-400">
                                    <span></span>
                                    <span>s/d <?php echo e($giftCard->expires_at?->format('d M Y') ?? 'Selamanya'); ?></span>
                                </div>
                            </div>
                        </div>

                        
                        <div x-show="editingGiftId === <?php echo e($giftCard->id); ?>" x-transition
                            ...
                            <form action="<?php echo e(route('vendor.gift-card.update', $giftCard)); ?>" method="POST"
                                class="space-y-4">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Kode Gift Card
                                            *</label>
                                        <input name="code" value="<?php echo e($giftCard->code); ?>" required
                                    ...
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Nominal (Rp)
                                            *</label>
                                        <input name="value" value="<?php echo e((int) $giftCard->value); ?>" type="number"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input name="expires_at" type="date"
                                            value="<?php echo e($giftCard->expires_at?->format('Y-m-d')); ?>" required
                                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-amber-400 focus:ring-1 focus:ring-amber-200 outline-none transition bg-white">
                                    </div>
                                    <div>
                                        <label class="text-xs text-gray-500 mb-1.5 block font-medium">Batas Penggunaan
                                            *</label>
                                        <input name="max_usages" value="<?php echo e($giftCard->max_usages); ?>" type="number"
                                ...
                                <div class="flex items-center gap-3 pt-2">
                                    <label class="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
                                        <input type="checkbox" name="is_active" value="1"
                                            <?php echo e($giftCard->is_active ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\fazar\indonesia-luxe-backup\indonesia-luxe\resources\views/vendor/promo/index.blade.php ENDPATH**/ ?>