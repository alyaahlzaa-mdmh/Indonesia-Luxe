    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <div class="flex gap-3 mt-4">
          ...
          <a href="<?php echo e(getWhatsappMeUrl()); ?>" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-green-400 transition">
...
</footer><?php /**PATH /var/www/indonesia-luxe/resources/views/partials/footer.blade.php ENDPATH**/ ?>